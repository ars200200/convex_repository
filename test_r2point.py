...
class TestR2Point:
    ...
    def test_intersect1(self):
        ...
        c, d = R2Point(0.0, 0.5), R2Point(1.0, 0.5)
        assert R2Point.intersect(a, b, c, d) == R2Point(0.0, 0.5)

    def test_intersect2(self):
        a, b = R2Point(0.0, 0.0), R2Point(0.0, 1.0)
        c, d = R2Point(1.0, 0.5), R2Point(1.0, 1.0)
        assert R2Point.intersect(a, b, c, d) is None

    def test_intersrect3(self):
        a, b = R2Point(0.0, 0.0), R2Point(0.0, 1.0)
        c, d = R2Point(0.0, 2.0), R2Point(1.0, 2.0)
        assert R2Point.intersect(a, b, c, d) is None
